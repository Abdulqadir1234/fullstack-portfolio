        ...
        <nav className={`fixed top-[2px] left-0 right-0 z-50 transition-all duration-500 ${
            isScrolled 
                ? theme === 'dark'
                    ...
                    : 'bg-white/95 backdrop-blur-xl shadow-lg border-b border-slate-200/50 py-0'
                : theme === 'dark'
                    ? 'bg-gradient-to-b from-slate-950/90 to-slate-950/70 py-2'
                    : 'bg-gradient-to-b from-white/90 to-slate-50/70 py-2'
        }`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 md:h-20 transition-all duration-300">
                    ...
                    <button
                        ...
                        className={`lg:hidden relative w-10 h-10 rounded-xl ${theme === 'dark' ? 'bg-slate-800/50 border-slate-700/50 text-slate-300 hover:text-white hover:border-primary-500/50 hover:bg-slate-800/80' : 'bg-slate-200/50 border-slate-300/50 text-slate-600 hover:text-slate-900 hover:border-primary-500/50 hover:bg-slate-300/80'} border backdrop-blur-sm flex items-center justify-center transition-all duration-300 active:scale-95 z-50`}
                    ...
                    <div className="flex-1 overflow-y-auto px-6 py-4 space-y-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
                        ...
                        <button
                            ...
                            className="relative flex items-center gap-4 w-full px-5 py-4 rounded-xl
                                ...
                                border-2 border-slate-700/50 hover:border-primary-500/50
                                transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                            style={{
                                animation: isMobileOpen ? `mobileNavSlide 0.4s ease-out ${(navLinks.length + 1) * 0.08}s both` : 'none'
                            }}
                        >
                            <span className="text-xl flex-shrink-0">
                                {theme === 'dark' ? '☀️' : '🌙'}
                        ...
                        <button
                            ...
                            className="relative flex items-center gap-4 w-full px-5 py-4 rounded-xl
                                ...
                                transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                            style={{
                                animation: isMobileOpen ? `mobileNavSlide 0.4s ease-out ${(navLinks.length + 2) * 0.08}s both` : 'none'
                            }}
                        >
