...
export default function Navbar() {
    ...
    return (
        ...
        <nav className={`fixed top-[2px] left-0 right-0 z-50 transition-all duration-500 ${
            isScrolled 
                ? 'bg-slate-950/90 backdrop-blur-xl shadow-2xl shadow-slate-950/60 border-b border-slate-800/30 py-0' 
                : 'bg-gradient-to-b from-slate-950/80 to-transparent py-2'
        }`}>
            ...
            {/* Mobile Nav Overlay */}
            <div className={`
                fixed inset-0 z-40 bg-slate-950/98 backdrop-blur-2xl lg:hidden
            ...
            `}>
                ...
                <div className="relative flex flex-col items-center justify-center h-full gap-3 px-8 py-20">
                    {navLinks.map((link, index) => {
                        ...
                        return (
                            <a
                                ...
                                onClick={(e) => { e.preventDefault(); handleNavClick(link.href); }}
                                className={`
                                    relative w-full max-w-sm px-8 py-5 text-center text-xl font-semibold rounded-2xl
                            ...
                            >
                                {/* Active indicator */}
                                {isActive && (
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 w-1.5 h-8 bg-gradient-to-b from-primary-400 to-purple-400 rounded-full" />
                                )}
                    ...
                    {/* Social links */}
                    <div className="flex items-center gap-4 mt-8 pt-8 border-t border-slate-800/50">
                        <a href="https://github.com/Abdulqadir1234" target="_blank" rel="noopener noreferrer" 
                           className="w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/50 flex items-center justify-center text-slate-400 hover:text-white hover:border-primary-500/50 hover:bg-slate-800/80 transition-all duration-300 hover:scale-110 active:scale-95">
                        ...
                        <a href="https://www.linkedin.com/in/abdul-qadir-nasrat-979b67326" target="_blank" rel="noopener noreferrer" 
                           className="w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/50 flex items-center justify-center text-slate-400 hover:text-blue-400 hover:border-blue-500/50 hover:bg-blue-500/10 transition-all duration-300 hover:scale-110 active:scale-95">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://wa.me/93745562728" target="_blank" rel="noopener noreferrer" 
                           className="w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/50 flex items-center justify-center text-slate-400 hover:text-green-400 hover:border-green-500/50 hover:bg-green-500/10 transition-all duration-300 hover:scale-110 active:scale-95">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
